#Change working directory to MicrobeReminModel_v1.0/Model/MRM1D using the setwd() command or using the Misc menu.  
...
TableCompare("../../Output/MRM1D/BacteriaRates/BacteriaRates_Sink2.00_Size0.0010_Qfrac0.50.out", "../../TestFiles/MRM1D/BacteriaRates/BacteriaRates_Sink2.00_Size0.0010_Qfrac0.50.out")

TableCompare("../../Output/MRM1D/MassTransferRates/MassTransferRates_Sink2.00_Size0.0010_Qfrac0.50.out", "../../TestFiles/MRM1D/MassTransferRates/MassTransferRates_Sink2.00_Size0.0010_Qfrac0.50.out")

TableCompare("../../Output/MRM1D/StateVariables/StateVariables_Sink2.00_Size0.0010_Qfrac0.50.out", "../../TestFiles/MRM1D/StateVariables/StateVariables_Sink2.00_Size0.0010_Qfrac0.50.out")
